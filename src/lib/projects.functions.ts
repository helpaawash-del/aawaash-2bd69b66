...
const PROJECT_LIST_COLUMNS =
  "id, slug, name, location, address, project_type, construction_status, visibility, display_priority, short_description, description, tag, price_from, price_min, price_max, area_min, area_max, total_buildings, total_floors, total_flats, available_flats, reserved_flats, sold_flats, total_units, sold_units, completion_percent, hero_hue, thumbnail_url, hero_banner_url, cover_url, logo_url, launch_date, possession_date, gallery_count, video_count, model_count, floor_plan_count, seo_title, seo_description, created_at";
