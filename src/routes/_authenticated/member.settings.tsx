  ...
  return (
    <DashboardShell role="member" profile={profile}>
      ...
      <section className="mt-6 grid gap-4 lg:grid-cols-2">
        ...
        <SectionCard title="Privacy & support">
      ...
      <section className="mt-6">
        <button
          onClick={signOut}
          disabled={signingOut}
          className="inline-flex h-12 w-full items-center justify-center gap-2 rounded-2xl border border-destructive/30 bg-destructive/5 text-sm font-semibold text-destructive shadow-[var(--shadow-soft)] disabled:opacity-50 sm:w-auto sm:px-8"
        >
      ...
      <p className="mt-6 text-center text-[11px] text-muted-foreground">
        <Link to="/member/profile" className="hover:text-foreground">
          Manage account
        </Link>
      </p>
    </DashboardShell>
